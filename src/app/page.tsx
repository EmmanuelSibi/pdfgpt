    ...
    <>
      <MaxWidthWrapper classname="mb-12 mt-28 sm:mt-14 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text 6xl lg:text-7xl">
          Chat with your <span className="text-green-500">documents</span> in
          seconds.{" "}
        </h1>
        <p className="mt-5 max-w prose text-zinc-700 sm:text-lg">
          Pdfgpt is a tool that allows you to chat with your documents. Simply
      ...
      <div>
        <div className="relative isolate">
          <div className=" pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-50">
            <div
              style={{
                clipPath:
          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xllg:p-4">
                  <Image
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center ">
            ...
            <p className="mt-4 text-lg text-gray-600">
              ...
              a pdf and start chatting with it.
            </p>
          </div>
        </div>
        {/* steps */}
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-0 border-zinc-300 py-2 pl-4 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-0 border-zinc-300 py-2 pl-4 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                {" "}
              It&apos;s that simple.Try out Pdfgpt today!
              </span>
            </div>
          </li>
        </ol>
